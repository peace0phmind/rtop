...
DROP TABLE IF EXISTS "GEOMS", "GEOGS", "NEWGEOMS";
DROP TYPE IF EXISTS "GEOMS", "GEOGS", "NEWGEOMS";
CREATE TABLE "GEOMS" ("id" INT PRIMARY KEY, "geom" GEOMETRY, "name" TEXT);
INSERT INTO "GEOMS" VALUES
  (1, 'POLYGON((2 2, 7 2, 7 5, 2 5, 2 2))', 'small rectangle'),
...
INSERT INTO "GEOGS" SELECT "id", "geom"::geography, "name" FROM "GEOMS";
